...
router.post('/', authorize('admin', 'salesman'), validate(createPaymentSchema), catchAsync(async (req, res) => {
...
router.patch('/:paymentId', authorize('admin', 'salesman'), validate(updatePaymentSchema), catchAsync(async (req, res) => {
